...
local _aimsp_settings; _aimsp_settings = {
    ...
    prefer = {
        looking_at_you = true, -- will prefer whoever is looking at you "the most", threat judging
    ...
    looking_at_tracers = {
        ...
        color = color3_new(237, 28, 28), -- color in rgb
        thickness = 2,
